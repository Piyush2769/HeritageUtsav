...
public class Mutex extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mutex);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarmutex);
        ...
        findViewById(R.id.regmutex).setOnClickListener(new View.OnClickListener() {
            @Override
