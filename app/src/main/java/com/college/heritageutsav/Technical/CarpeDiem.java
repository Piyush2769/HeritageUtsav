...
public class CarpeDiem extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_carpe_diem);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolcarpediem);
        ...
        findViewById(R.id.regcarpe).setOnClickListener(new View.OnClickListener() {
            @Override
