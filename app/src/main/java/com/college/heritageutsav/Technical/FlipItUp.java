...
public class FlipItUp extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_flip_it_up);
        ...
        findViewById(R.id.regflip).setOnClickListener(new View.OnClickListener() {
            @Override
