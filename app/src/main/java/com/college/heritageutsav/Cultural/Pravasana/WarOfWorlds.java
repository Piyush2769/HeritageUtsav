...
public class WarOfWorlds extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_war_of_worlds);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarwar);
        ...
        findViewById(R.id.regwar).setOnClickListener(new View.OnClickListener() {
            @Override
