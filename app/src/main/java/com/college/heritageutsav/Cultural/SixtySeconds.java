...
public class SixtySeconds extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sixty_seconds);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolsixty);
        ...
        findViewById(R.id.regsixty).setOnClickListener(new View.OnClickListener() {
            @Override
