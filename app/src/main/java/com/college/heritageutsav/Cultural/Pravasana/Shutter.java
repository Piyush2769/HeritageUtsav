...
public class Shutter extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shutter);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbarshutter);
        ...
        findViewById(R.id.regshutter).setOnClickListener(new View.OnClickListener() {
            @Override
